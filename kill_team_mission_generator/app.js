...
const translations = {
  en: {
    ...
    setupReq1_text: "Two Kill Teams with datacards/tokens, your 30\"x22\" board & terrain (e.g. from the Starter Set), 3 objective markers (P1, P2, and Centre), 6-sided dice (D6), and a measuring tape (in inches).",
    setupReq2_title: "2. Objective Placement:",
    setupReq2_text: "Look at the generated Map diagram above! Place your 6 objective markers on your physical table exactly where the circles show. (Yes, P1 and P2 ARE objective markers too! They are the players' home objective markers. 1-4 are the neutral objective markers).",
    setupReq3_title: "3. Do you need all the checkboxes below?",
    setupReq3_text: "NO! You do NOT need to check every box to play. The checklist below is an optional, step-by-step tournament companion to make sure you don't forget official rules (like drafting equipment or CP starting rules). For casual games with buddies: Just generate a mission above, place your terrain and 3 objectives, deploy your models in your drop zones, start with 2 Command Points each, and start rolling dice!",
  ...
  de: {
    ...
    setupReq1_text: "Zwei Kill Teams samt Datenkarten/Markern, euer 30\"x22\" Spielfeld & Gelände (z.B. aus der Starterbox), 3 Missionsziel-Marker (P1, P2 und Zentrum), ganz normale Sechsseiter-Würfel (W6) und ein Maßband (in Zoll).",
    setupReq2_title: "2. Missionsziele platzieren:",
    setupReq2_text: "Schau dir die generierte Karte oben an! Platziert eure 6 Missionsziel-Marker genau dort auf eurem Spielfeld, wo es die Kreise anzeigen. (Ja, P1 und P2 SIND ebenfalls Missionsziel-Marker! Sie sind die Heimat-Marker der Spieler. 1-4 sind die neutralen Missionsziel-Marker).",
    setupReq3_title: "3. Musst du alle Checkboxen unten ankreuzen?",
    setupReq3_text: "NEIN! Du musst nicht jede Checkbox anklicken, um zu spielen. Die Liste unten ist nur eine optionale, schrittweise Hilfe (z.B. für Turniere), damit man offizielle Regeln wie das Ziehen von Ausrüstungen oder Start-Befehlspunkte nicht vergisst. Für lockere Spiele mit Freunden: Generiere einfach oben eine Mission, platziere dein Gelände und 3 Missionsziele, stelle deine Modelle auf, startet mit je 2 Befehlspunkten und fangt an zu würfeln!",
