...
const translations = {
  en: {
    ...
    setupReq2_text: "Look at the generated Map diagram above! Place your 3 objectives on your physical table exactly where the circles show (P1 is Player 1's marker, P2 is Player 2's marker, and C is the neutral Centre marker).",
  ...
  de: {
    ...
    setupReq2_text: "Schau dir die generierte Karte oben an! Platziert eure 3 Missionsziele genau dort auf eurem Spielfeld, wo es die Kreise anzeigen (P1 und P2 sind die Spieler-Missionsziele, C ist das neutrale Zentrum).",
