...
const OPERATIVES_DB = {
    en: [
        { name: "Aquilon Tempestor", w: 9, apl: 3, sv: "4+", fixedWeapons: ["Fists"], weaponSelect1: ["Hot-shot laspistol", "Relic bolt pistol", "Hot-shot lascarbine"], weaponSelect2: ["Power weapon", "Chainsword"] },
        { name: "Aquilon Gunfighter", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Hot-shot laspistols (focused)", "Hot-shot laspistols (salvo)", "Hot-shot laspistols (point-blank)", "Fists"] },
        { name: "Aquilon Grenadier", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Hot-shot laspistol", "Melta bomb", "Fists"] },
        { name: "Aquilon Marksman", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Hot-shot long-las (concealed)", "Hot-shot long-las (mobile)", "Hot-shot long-las (stationary)", "Fists"] },
        { name: "Aquilon Servo-sentry", w: 10, apl: 2, sv: "3+", weaponSelect1: ["Flamer", "Grenade launcher (frag)", "Grenade launcher (krak)", "Hot-shot volley gun (focused)", "Hot-shot volley gun (sweeping)"] },
        { name: "Aquilon Gunner", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Fists"], weaponSelect1: ["Melta carbine", "Plasma carbine (standard)", "Plasma carbine (supercharge)"] },
        { name: "Aquilon Precursor", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Hot-shot laspistol", "Tempestus dagger"] },
        { name: "Aquilon Trooper", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Hot-shot lascarbine", "Fists"] }
    ],
    de: [
        { name: "Aquilon-Tempestor", w: 9, apl: 3, sv: "4+", fixedWeapons: ["Fäuste"], weaponSelect1: ["Hochenergie-Laserpistole", "Reliktboltpistole", "Hochenergie-Laserkarabiner"], weaponSelect2: ["Energiewaffe", "Kettenschwert"] },
        { name: "Aquilon-Revolverheld", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Hochenergie-Laserpistolen (gezielt)", "Hochenergie-Laserpistolen (Salve)", "Hochenergie-Laserpistolen (aus nächster Nähe)", "Fäuste"] },
        { name: "Aquilon-Grenadier", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Hochenergie-Laserpistole", "Melterbombe", "Fäuste"] },
        { name: "Aquilon-Scharfschütze", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Hochenergie-Scharfschützen-Lasergewehr (auf der Lauer)", "Hochenergie-Scharfschützen-Lasergewehr (in Bewegung)", "Hochenergie-Scharfschützen-Lasergewehr (stationär)", "Fäuste"] },
        { name: "Aquilon-Wachtservitor", w: 10, apl: 2, sv: "3+", weaponSelect1: ["Flammenwerfer", "Granatwerfer (Fragment)", "Granatwerfer (Spreng)", "Hochenergie-Salvengewehr (gezielt)", "Hochenergie-Salvengewehr (wahllos)"] },
        { name: "Aquilon-Schütze", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Fäuste"], weaponSelect1: ["Melterkarabiner", "Plasmakarabiner (Standard)", "Plasmakarabiner (Überladung)"] },
        { name: "Aquilon-Wegbereiter", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Hochenergie-Laserpistole", "Tempestus-Dolch"] },
        { name: "Aquilon-Soldat", w: 8, apl: 2, sv: "4+", fixedWeapons: ["Hochenergie-Laserkarabiner", "Fäuste"] }
    ]
};
