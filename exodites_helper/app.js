document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- I18N LOGIC ---
    let currentLang = localStorage.getItem('hearthkyn_lang') || 'en';
    ...
    document.getElementById('lang-en').addEventListener('click', () => {
        currentLang = 'en';
        localStorage.setItem('hearthkyn_lang', 'en');
        applyTranslations();
    });

    document.getElementById('lang-de').addEventListener('click', () => {
        currentLang = 'de';
        localStorage.setItem('hearthkyn_lang', 'de');
        applyTranslations();
    });
    ...
    function renderBuilder() {
        ...
        OPERATIVES_DB[currentLang].forEach(op => {
            ...
            let sel1, sel2;
            if (op.weaponSelect1 && op.weaponSelect1.length > 0) {
            ...
            if (op.weaponSelect2 && op.weaponSelect2.length > 0) {
    ...
    createTokenItem("Enemy Target 1 Custom Tracker");
    createTokenItem("Enemy Target 2 Custom Tracker");
