...
const OPERATIVES_DB = {
    en: [
        { id: 'leader', name: 'ARBITES PROCTOR-EXACTANT', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 9 }, abilities: ['<strong>Nuncio-aquila (0 AP):</strong> Place/move marker. Enemies within 3" of marker pay +1 AP for mission actions. Treat their APL as 1 lower for control.'], weaponSelect1: ['Combat shotgun; Repression baton', 'Shotpistol; Dominator maul'] },
        { id: 'castigator', name: 'ARBITES CASTIGATOR', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Engendered Focus:</strong> Ignore changes to stats (except Save).', '<strong>Zealous Dedication:</strong> Whenever taking 3+ dmg, roll D6. On 5+, subtract 1 from dmg.', '<strong>Castigator\'s Arrest:</strong> Isolated enemies in control range cannot Fall Back.'], weaponSelect1: ['Combat shotgun; Excruciator maul', 'Shotpistol; Excruciator maul'] },
        { id: 'chirurgant', name: 'ARBITES CHIRURGANT', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Medic!:</strong> Once per TP, save visible friendly in 3" from dying (leaves at 1 LP, free Dash, APL -1).', '<strong>Medikit (1 AP):</strong> Friendly in control range heals 2D3 wounds.'], weaponSelect1: ['Combat shotgun; Repression baton', 'Shotpistol; Shock maul'] },
        { id: 'leashmaster', name: 'ARBITES LEASHMASTER', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Handler:</strong> Activate ready R-VR Cyber-Mastiff at the same time.', '<strong>Attack Pattern (STRATEGIC GAMBIT):</strong> Give mastiff Aggressive (Relentless), Swift (+2" Move), or Defensive (+1 Save).', '<strong>R-VR Command (0 AP):</strong> Change the Cyber-Mastiff\'s attack pattern.'], weaponSelect1: ['Combat shotgun; Repression baton', 'Shotpistol; Shock maul'] },
        { id: 'mastiff', name: 'R-VR CYBER-MASTIFF', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Beast:</strong> Cannot shoot, open doors, or carry equipment.', '<strong>Apprehend (0 AP):</strong> Enemy in control range gets -1 Hit and cannot Fall Back until it leaves.'], fixedWeapons: ['Mechanical bite'] },
        { id: 'malocator', name: 'ARBITES MALOCATOR', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Acute Focus:</strong> Once per activation, perform mission action or Veriscant for 1 less AP.', '<strong>Veriscant (1 AP):</strong> Select visible enemy. Friendly attacks against it gain Lethal 5+ and Severe.'], weaponSelect1: ['Combat shotgun; Repression baton', 'Shotpistol; Shock maul'] },
        { id: 'marksman', name: 'ARBITES MARKSMAN', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Concealed Position:</strong> Can fire concealed executioner shotgun on first Shoot action.', '<strong>Optics (1 AP):</strong> Shotgun gains Lethal 5+ and ignores obscurement until next activation.'], weaponSelect1: ['Executioner shotgun; Repression baton', 'Shotpistol; Shock maul'] },
        { id: 'revelatum', name: 'ARBITES REVELATUM', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>First in the Field (STRATEGIC GAMBIT):</strong> Free Reposition if wholly in drop zone.', '<strong>Spot (1 AP):</strong> Visible enemy in 8". Friendly attacks against it gain Seek Light and ignore obscurement.'], weaponSelect1: ['Scoped shotpistol; Repression baton', 'Scoped shotpistol; Shock maul'] },
        { id: 'subductor1', name: 'ARBITES SUBDUCTOR (1)', limit: 4, stats: { apg: 2, b: '6"', rw: '3+', lp: 8 }, abilities: ['<strong>Stubborn Subjugator:</strong> Ignore changes to Hit stat of melee weapons.'], fixedWeapons: ['Shotpistol', 'Shock maul'] },
    ...
    de: [
        { id: 'leader', name: 'ARBITES-PROCTOR-EXACTANT', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 9 }, abilities: ['<strong>Nuncio-Aquila (0 AP):</strong> Platziere/Bewege Marker. Feinde in 3" zahlen +1 AP für Missionsaktionen. APL zählt als 1 niedriger für Kontrolle.'], weaponSelect1: ['Sturmschrotflinte; Repressor-Schlagstock', 'Schrotpistole; Dominator-Energiehammer'] },
        { id: 'castigator', name: 'ARBITES-CASTIGATOR', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Antrainierter Fokus:</strong> Ignoriert Änderungen an Profilwerten (außer RW).', '<strong>Eifrige Hingabe:</strong> Bei 3+ Schaden W6 würfeln. Bei 5+ Schaden um 1 reduzieren.', '<strong>Festnahme des Castigators:</strong> Isolierte Feinde in KontrollRW können nicht Zurückfallen.'], weaponSelect1: ['Sturmschrotflinte; Tormentor-Streitkolben', 'Schrotpistole; Tormentor-Streitkolben'] },
        { id: 'chirurgant', name: 'ARBITES-CHIRURGANT', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Sani!:</strong> 1x pro Wendepunkt sichtbaren Kyn in 3" vor dem Tod bewahren (bleibt bei 1 LP, freier Spurt, APL -1).', '<strong>Sanitätsausrüstung (1 AP):</strong> Heilt 2W3 LP bei Kyn in K-RW.'], weaponSelect1: ['Sturmschrotflinte; Repressor-Schlagstock', 'Schrotpistole; Schockstab & Schutzschild'] },
        { id: 'leashmaster', name: 'ARBITES-LEASHMASTER', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Hundeführer:</strong> Aktiviere R-VR-Cybermastiff gleichzeitig.', '<strong>Angriffsmuster (STRATEGISCHES WAGNIS):</strong> Mastiff erhält Aggressiv (Unerbittlich), Schnell (+2" B) oder Defensiv (+1 RW).', '<strong>R-VR-Befehl (0 AP):</strong> Ändere das Angriffsmuster des Cybermastiffs.'], weaponSelect1: ['Sturmschrotflinte; Repressor-Schlagstock', 'Schrotpistole; Schockstab & Schutzschild'] },
        { id: 'mastiff', name: 'R-VR-CYBERMASTIFF', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Bestie:</strong> Kann nicht schießen, Türen öffnen oder Ausrüstung tragen.', '<strong>Fassen (0 AP):</strong> Feind in K-RW erhält -1 Trefferwert und kann nicht Zurückfallen.'], fixedWeapons: ['Mechanische Kiefer'] },
        { id: 'malocator', name: 'ARBITES-MALOCATOR', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Geschärfter Fokus:</strong> 1x pro Aktivierung Missionsaktion oder Veriscant für 1 AP weniger.', '<strong>Veriscant (1 AP):</strong> Wähle sichtbaren Feind. Eigene Attacken gegen ihn erhalten Tödlich 5+ und Schwer.'], weaponSelect1: ['Sturmschrotflinte; Repressor-Schlagstock', 'Schrotpistole; Schockstab & Schutzschild'] },
        { id: 'marksman', name: 'ARBITES-MARKSMAN', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Verborgene Position:</strong> Kann verborgene Executor-Schrotflinte bei erster Schießen-Aktion abfeuern.', '<strong>Optik (1 AP):</strong> Schrotflinte erhält Tödlich 5+ und ignoriert Verdunkelung bis zur nächsten Aktivierung.'], weaponSelect1: ['Executor-Schrotflinte; Repressor-Schlagstock', 'Schrotpistole; Schockstab & Schutzschild'] },
        { id: 'revelatum', name: 'ARBITES-REVELATUM', limit: 1, stats: { apg: 2, b: '6"', rw: '4+', lp: 8 }, abilities: ['<strong>Der Erste im Feld (STRATEGISCHES WAGNIS):</strong> Kostenlose Neupositionierung, wenn komplett in Aufstellungszone.', '<strong>Sichten (1 AP):</strong> Sichtbarer Feind in 8". Eigene Attacken erhalten Zielsucher leicht und ignorieren Verdunkelung.'], weaponSelect1: ['Schrotpistole mit Zielvisier; Repressor-Schlagstock', 'Schrotpistole mit Zielvisier; Schockstab & Schutzschild'] },
        { id: 'subductor1', name: 'ARBITES-SUBDUCTOR (1)', limit: 4, stats: { apg: 2, b: '6"', rw: '3+', lp: 8 }, abilities: ['<strong>Hartnäckiger Unterwerfer:</strong> Ignoriert Änderungen am Trefferwert von Nahkampfwaffen.'], fixedWeapons: ['Schrotpistole', 'Schockstab & Schutzschild'] },
...
const WEAPONS_DB = {
    ...
    "Excruciator maul": {
        ...
        "h": "3+",
        "d": "5/5",
        "wr": "Rending, Shock Engendered Focus: You can ignore any changes to this operative’s stats (including its weapons’ stats, but excluding its Save stat)."
    },
    "Mechanical bite": {
        "a": "4",
        "h": "4+",
        "d": "3/5",
        "wr": "Lethal 5+ Beast: This operative cannot perform any actions other than Apprehend, Charge, Dash, Fall Back, Fight,"
    },
    ...
    "Shock maul & assault shield": {
        ...
        "h": "4+",
        "d": "4/4",
        "wr": "Shock, Repress* Stubborn Subjugator: You can ignore any changes to the Hit stat of this operative’s melee weapons. EXACTION SQUAD , IMPERIUM, ADEPTUS ARBITES, SUBDUCTOR"
    }
},
    de: {
    "Dominator-Energiehammer": {
    ...
    "Sturmschrotflinte (kurze Reichweite)": {
        "a": "4",
        "h": "3+",
        "d": "4/4",
        "wr": "Reichweite 6 Zoll"
    },
    "Sturmschrotflinte (große Reichweite)": {
        "a": "4",
        "h": "5+",
        "d": "2/2",
        "wr": "-"
    },
    "Repressor-Schlagstock": {
        "a": "3",
        "h": "4+",
        "d": "2/3",
        "wr": "-"
    },
    "Tormentor-Streitkolben": {
        "a": "4",
        "h": "3+",
        "d": "5/5",
        "wr": "Rüstungsbrechend, Schock Ungebrochener Fokus: Du kannst alle Änderungen für Profilwerte dieses Kämpfers ignorieren (inklusive für Profilwerte seiner Waffen, jedoch nicht für seinen Rüstungswert)."
    },
    "Schrotpistole": {
        "a": "4",
        "h": "4+",
    ...
    "Mechanische Kiefer": {
        ...
        "h": "4+",
        "d": "3/5",
        "wr": "Tödlich 5+ Bestie: Dieser Kämpfer kann keine Akti- onen außer Fass!, Angreifen, Sprin- ten, Zurückziehen, Kämpfen, Wach-"
    },
    "Schrotpistole mit Zielvisier (lange Reichweite)": {
        "a": "4",
        "h": "3+",
        "d": "3/3",
        "wr": "-"
    },
    "Schrotpistole mit Zielvisier (kurze Reichweite)": {
        "a": "4",
        "h": "3+",
        "d": "3/3",
    ...
    "Maschinengewehr (gezielt)": {
        "a": "5",
        "h": "4+",
        "d": "4/5",
        "wr": "Schwer (nur Sprinten)"
    },
    "Maschinengewehr (wahllos)": {
        "a": "4",
        "h": "4+",
        "d": "4/5",
        "wr": "Schwer (nur Sprinten),  Schwall 1 Zoll"
    },
    "Netzwerfer": {
        "a": "4",
        "h": "3+",
        "d": "4/5",
        "wr": "Reichweite 12 Zoll, Heftig, Betäuben"
    },
    "Executor-Schrotflinte (verborgen)": {
        "a": "4",
        "h": "2+",
        "d": "4/0",
        "wr": "Verheerend 4, Schwer, Schalldämpfer, Verborgen auf der Lauer*"
    },
    "Executor-Schrotflinte (mobil)": {
        "a": "4",
        "h": "3+",
        "d": "4/4",
        "wr": "-"
    },
    "Executor-Schrotflinte (stationär)": {
        "a": "4",
        "h": "2+",
        "d": "4/0",
        "wr": "Verheerend 4, Schwer"
    },
    "Schockstab & Schutzschild": {
        "a": "4",
        "h": "4+",
        "d": "4/4",
        "wr": "Schock, Unterdrücken* Entschlossener Gesetzeshüter: Du kannst beliebige Änderungen auf den Trefferwert der Nahkampfwaffen dieses Kämpfers ignorieren. VOLLSTRECKERTRUPP , IMPERIUM, ADEPTUS ARBITES, SUBDUCTOR"
    }
}
};
